...
if __name__ == '__main__' :
  ...
  points1 = fbc.getLandmarks(detector, predictor, cv2.cvtColor(img1, cv2.COLOR_BGR2RGB))
  points2 = fbc.getLandmarks(detector, predictor, cv2.cvtColor(img2, cv2.COLOR_BGR2RGB))
